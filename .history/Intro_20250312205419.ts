...
/**
    ...
    * 7. Typescript Needs to be compiled to JavaScript.  Javascript Directly run in the browser. Javascript Directly Executed by the browser and node.js will run the javascript code.
 */