...
/**
    ...
    * 18. Development speed = slower due to type checks and compiling. faster as no compilation is required.
    * 19. Community = Growing Particularly for large scale applications. Large and well established.
    ...
    * 21. ES6 features = Include all ES6 Features and future proposals. Include all ES6 Features but depends on browser/node.js.
 */